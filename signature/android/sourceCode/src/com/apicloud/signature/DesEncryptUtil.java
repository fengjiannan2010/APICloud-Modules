...
public class DesEncryptUtil {
	...
	public static String encryptCondition(String encryptString, String key) {
		try {
			String afterBase64Encode = Base64.encodeToString(
					encryptString.getBytes("UTF-8"), Base64.NO_WRAP);
			System.out.println(afterBase64Encode);
			String afterEncrypt = DesEncryptUtil.encryptToHex(
					afterBase64Encode.getBytes("UTF-8"), key);
			return afterEncrypt;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static String decryptString(String decryptsTring, String key) {
		String str = "";
		try {
			String afterDecrypt = DesEncryptUtil.decrypt(decryptsTring, key);
			str = new String(Base64.decode(afterDecrypt.getBytes("UTF-8"),
					Base64.NO_WRAP));
		} catch (Exception e) {
			e.printStackTrace();
		} catch (Throwable e) {
