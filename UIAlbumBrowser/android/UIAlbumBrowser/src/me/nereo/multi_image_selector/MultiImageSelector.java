...
public class MultiImageSelector {
    ...
    public MultiImageSelector isOpen(boolean open){
    	isOpen = open;
    	return sSelector;
    }
    ...
    public void start(Activity activity, int requestCode){
        ...
        if(hasPermission(context)) {
        	...
        	int mis_error_no_permission_id = ResUtils.getInstance().getStringId(context, "mis_error_no_permission");
            Toast.makeText(context, mis_error_no_permission_id, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private Intent createIntent(Context context){
        ...
        intent.putExtra("immersive", isImmersive);
